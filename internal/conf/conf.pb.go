...
type Kube struct {
	...
	Clusters []*Kube_Clusters `protobuf:"bytes,1,rep,name=clusters,proto3" json:"clusters,omitempty"`
}
...
func (x *Kube) GetClusters() []*Kube_Clusters {
	if x != nil {
		return x.Clusters
	}
	return nil
...
func (x *Kube_Clusters) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Kube_Clusters) ProtoMessage() {}

func (x *Kube_Clusters) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Kube_Clusters.ProtoReflect.Descriptor instead.
func (*Kube_Clusters) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{3, 0}
}

func (x *Kube_Clusters) GetClusterName() string {
	if x != nil {
...
func (x *Kube_Clusters) GetConfig() string {
	if x != nil {
		return x.Config
	}
	return ""
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x04, 0x6b, 0x75, 0x62, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x6b, 0x72,
	0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x4b, 0x75, 0x62, 0x65, 0x52, 0x04, 0x6b,
	0x75, 0x62, 0x65, 0x22, 0xb8, 0x02, 0x0a, 0x06, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12, 0x2b,
	...
	0x52, 0x0c, 0x77, 0x72, 0x69, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0x83,
	0x01, 0x0a, 0x04, 0x4b, 0x75, 0x62, 0x65, 0x12, 0x35, 0x0a, 0x08, 0x63, 0x6c, 0x75, 0x73, 0x74,
	0x65, 0x72, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x6b, 0x72, 0x61, 0x74,
	0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x4b, 0x75, 0x62, 0x65, 0x2e, 0x43, 0x6c, 0x75, 0x73,
	0x74, 0x65, 0x72, 0x73, 0x52, 0x08, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x73, 0x1a, 0x44,
	0x0a, 0x08, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x73, 0x12, 0x20, 0x0a, 0x0b, 0x63, 0x6c,
	...
	0x6e, 0x66, 0x69, 0x67, 0x42, 0x2d, 0x5a, 0x2b, 0x6b, 0x75, 0x62, 0x65, 0x2d, 0x6d, 0x61, 0x6e,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Kube_Clusters)(nil),       // 8: kratos.api.Kube.Clusters
	(*durationpb.Duration)(nil), // 9: google.protobuf.Duration
}
var file_conf_conf_proto_depIdxs = []int32{
	1,  // 0: kratos.api.Bootstrap.server:type_name -> kratos.api.Server
	2,  // 1: kratos.api.Bootstrap.data:type_name -> kratos.api.Data
	3,  // 2: kratos.api.Bootstrap.kube:type_name -> kratos.api.Kube
	...
	8,  // 7: kratos.api.Kube.clusters:type_name -> kratos.api.Kube.Clusters
